const zh = {
  ...
  "settings.provider": "邮件服务商",
  "settings.providerDesc":
    "部分托管平台会屏蔽 SMTP 端口（例如 Render 免费版屏蔽 25/465/587）。SendGrid 走 HTTPS（443 端口），随处可用。",
  "settings.providerSmtp": "SMTP",
  "settings.providerSendgrid": "SendGrid（HTTP API）",
  "settings.sendgridApiKey": "SendGrid API 密钥",
  "settings.sendgridApiKeyDesc": "在 SendGrid 中创建：设置 → API Keys（需要 Mail Send 权限）。",
  "settings.sendgridFrom": "发件人地址",
  "settings.sendgridFromDesc": "必须是 SendGrid 中已验证的发件人：设置 → Sender Authentication。",
  "settings.testEmail": "发送测试邮件",
  "settings.testEmailDesc": "发送测试邮件以验证邮件配置。",
