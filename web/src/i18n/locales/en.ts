const en = {
  ...
  "settings.provider": "Email Provider",
  "settings.providerDesc":
    "SMTP is blocked on some hosts (e.g. Render free tier blocks ports 25/465/587). SendGrid uses HTTPS (port 443) and works everywhere.",
  "settings.providerSmtp": "SMTP",
  "settings.providerSendgrid": "SendGrid (HTTP API)",
  "settings.sendgridApiKey": "SendGrid API Key",
  "settings.sendgridApiKeyDesc": "Create in SendGrid: Settings → API Keys (Mail Send permission).",
  "settings.sendgridFrom": "From Address",
  "settings.sendgridFromDesc": "Must be a verified sender in SendGrid: Settings → Sender Authentication.",
  "settings.testEmail": "Send Test Email",
  "settings.testEmailDesc": "Send a test email to verify your email configuration.",
